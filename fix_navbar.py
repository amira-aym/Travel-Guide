...
# Match the entire <nav id="mainNavbar">...</nav>
nav_pattern = re.compile(r'<nav id="mainNavbar".*?</nav>', re.DOTALL)

clean_nav = """<nav id="mainNavbar" class="navbar navbar-expand-lg bg-body position-sticky top-0 start-0 end-0 border-bottom z-3">
        <div class="container-fluid px-4">

            <!-- Logo -->
            <a class="navbar-brand logo fw-bold text-body fs-3 d-flex align-items-center" href="#">
                <i class="bi bi-airplane-fill text-primary me-2"></i> travel guide
            </a>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body">
                    ...
                    <div class="d-flex align-items-center right-links gap-3 mt-3 mt-lg-0 border-top border-lg-0 pt-3 pt-lg-0">
                        ...
                        <!-- Dark Mode Toggle -->
                        <button class="btn btn-link nav-link px-2 dark-mode-btn ms-2" id="darkModeToggle" aria-label="Toggle Dark Mode" title="Dark Mode" style="color: inherit;">
...
html = nav_pattern.sub(clean_nav, html)

with open("index.html", "w", encoding="utf-8") as f:
    f.write(html)

print("Navbar fully cleaned and repaired")
